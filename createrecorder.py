...
tf.app.flags.DEFINE_string('data_directory', 'Texcrop/',
                           'Training data directory')
tf.app.flags.DEFINE_string('output_directory', 'recorderdata/',
                           'Output data directory')

tf.app.flags.DEFINE_integer('train_shards', 400,
...
tf.app.flags.DEFINE_string('labels_file', 'ave_20.csv', 'Labels file')
...
def _process_dataset(directory, labels_file):
  ...
  trainfilenames=filenames[0:36000]
  valfilenames=filenames[36000:]
